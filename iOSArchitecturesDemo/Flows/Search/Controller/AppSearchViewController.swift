...
final class AppSearchViewController: UIViewController {
    ...
    internal var searchAppResult = [ITunesApp](){
        didSet {
...
extension AppSearchViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let app = self.searchAppResult[indexPath.row]
...
extension AppSearchViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let app = searchAppResult[indexPath.row]
...
extension AppSearchViewController: SearchViewInput {
